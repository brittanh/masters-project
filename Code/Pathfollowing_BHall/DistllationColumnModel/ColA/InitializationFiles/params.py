...
params = {}
params['dist'] = {'F_0': F_0, 'NT': NT, 'zF': zF, 'qF': qF, 'NF': NF, 'VB': VB, 'LT': LT, 'F': F, 'alpha': alpha, 'B': B, 'D': D, 'zF': zF, 'Muw': Muw, 'L0': L0, 'L0b': L0b, 'qF0': qF0, 'F0': F0, 'taul': taul}
params['cstr'] = {'k1': k1}
