...
def pfNMPC(optProblem, system, MPCit, N, T, tmeasure, xmeasure, u0, params):
    ...
    while (iter <= MPCit):
        ...
        #advanced-step NMPC
        primalNLP, dualNLP, lb, ub, objVal, params, elapsednlp = solveOpt(optProblem, x0, u0, N, z1, params)
        ...
        primalPF, _, elapsedqp = pathfollowing(lambda p: ColCSTR_pf(p), p_init, p_final, xstart, ystart, delta_t, lb_init, ub_init, 0, N)
