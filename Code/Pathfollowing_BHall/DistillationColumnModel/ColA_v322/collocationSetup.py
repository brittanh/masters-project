...
def collocationSetup():
    ...
    for j in range(0,d+1):
        #Lagrange poly to get poly basis at the colloc point
        coeff = 1
        ...
        #Evaluate the time derivative of the polynomial at
        #all collocation points to get the coefficients of the
        #continuity equation
        pder = polyder(coeff)
        for r in range(0,d+1):
