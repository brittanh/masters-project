...
params = {}
params['dist'] = {'NC':NC,'F_0': F_0, 'NT': NT, 'zF': zF,
    'qF': qF, 'NF': NF, 'VB': VB, 'LT': LT, 'F': F, 'alpha': alpha,
    'B': B, 'D': D, 'zF': zF,'Muw': Muw, 'L0': L0, 'L0b': L0b,
    'qF0': qF0, 'F0': F0, 'taul': taul,'V0':V0, 'lam':lam, 'MO': MO}
params['cstr'] = {'k1': k1}
params['price'] = {'pf': pf, 'pV': pV, 'pB': pB, 'pD': pD}
params['bounds'] = {'x_min':x_min, 'x_max':x_max, 'u_min': u_min,
    'u_max': u_max, 'lbx': lbx, 'ubx': ubx, 'ubg': ubg, 'lbg': lbg}
params['gain'] = {'MDs':MDs,'MBs':MBs,'Ds':Ds,'Bs':Bs,
                'KcD':KcD, 'KcB':KcB}
params['prob'] = {'nx':nx, 'nu':nu, 'nk':nk, 'tf': tf,
                'h': h, 'ns':ns}
