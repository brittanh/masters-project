...
#from qp_solve_2 import qp_solve_2
...
def pathfollowing(problem, p_init, p_final, x_init, y_init, delta_t, lb_init,
    ...
    while t<= 1:
        ...
        qp_exit, y, x_qpopt, lam_qpopt, mu_qpopt, qp_run = qp_solve(prob, p_init, x_init, y_init, step, lb, ub, N, x0, lb_init, ub_init)

        elapsedqp += qp_run


    return x_qpopt, lam_qpopt, elapsedqp
