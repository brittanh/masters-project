...
x_opt, lam_opt, mu_opt, cos = nlp_solve(prob, obj, p_init, x_init, y_init)
...
#x_init, y_init, t_list, x_list_0, x_list_1 = pathfollowing(t, delta_t, alpha1, p_init, p_final, x_init, y_int, chi, lam_opt, mu_opt)
